...
<form action="${pageContext.request.contextPath}/addUserServlet" method="post">
    <table class="tdh_form">
        ...
        <tr>
            ...
            <td class="tdCont"><input id="yhidText" class="inputText" type="text" placeholder="请输入"/></td>
            <td class="tdTitle"><i class="required">*</i>用户姓名</td>
            <td class="tdCont"><input id="yhxmText" class="inputText" type="text" placeholder="请输入"/></td>
            <td class="tdTitle"><i class="required">*</i>排序号</td>
            <td class="tdCont"><input id="pxhText" class="inputText" type="text" placeholder="请输入"/></td>
        </tr>
        <tr>
            <td class="tdTitle">出生日期</td>
            <td class="tdCont"><input class="Wdate inputText" type="text" onclick="WdatePicker()" readonly/></td>
            <td class="tdTitle"><i class="required">*</i>用户口令</td>
            <td class="tdCont"><input id="yhklText" class="inputText" type="text" placeholder="请输入"/></td>
            <td class="tdTitle"><i class="required">*</i>重复口令</td>
            <td class="tdCont"><input id="cfklText" class="inputText" type="text" placeholder="请输入"/></td>
        </tr>
        <tr>
